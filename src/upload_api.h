...
// upload_time_ms 是「上傳當下」的真實世界 epoch ms，wall_clock_synced 為
// false 時代表這個時間戳不可信，整個 uploadTime 欄位會被省略、不會謊報一個
// 假的時間戳。source_kind 是這批 records 的來源裝置種類（fora_device_kind_t，
